 ...
 * For recycle view use cursor adapter.
 */

public abstract class RecycleCursorAdapter<VH extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<VH> implements Filterable,
     ...
     */
    public RecycleCursorAdapter(Context context, Cursor c, int flags) {
